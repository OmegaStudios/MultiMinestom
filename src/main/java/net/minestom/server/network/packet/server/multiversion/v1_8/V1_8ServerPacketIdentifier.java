...
public class V1_8ServerPacketIdentifier {
    ...
    public static final int SPAWN_ENTITY = 0x0E; //Spawn Object at wiki.vg
    public static final int SPAWN_LIVING_ENTITY = 0x0F; //Spawn Mob at wiki.vg
    ...
    public static final int MAP_CHUNK_BULK = 0x26; //used to send multiple chunks at once; does not exist in 1.17
    ...
    public static final int SPAWN_GLOBAL_ENTITY = 0x2C; //used for thunderbolt strikes; does not exist in 1.17
    ...
    public static final int CONFIRM_TRANSACTION = 0x32; //used to confirm a gui click; does not exist in 1.17
    public static final int UPDATE_SIGN = 0x33; //used to update sign text for a player; does not exist in 1.17
    public static final int MAP_DATA = 0x34; //Map at wiki.vg
    public static final int BLOCK_ENTITY_DATA = 0x35; //Update Block Entity on wiki.vg
    public static final int OPEN_SIGN_EDITOR = 0x36;
    public static final int STATISTICS = 0x37;
    public static final int PLAYER_INFO = 0x38; //Player List Item at wiki.vg
    ...
    public static final int COMBAT_EVENT = 0x42; //1.17 has 3 different packets for this. ENTER_COMBAT_EVENT, END_COMBAT_EVENT, DEATH_COMBAT_EVENT
    public static final int CAMERA = 0x43;
    public static final int WORLD_BORDER = 0x44; //1.17 has 6 different packets for this
    public static final int TITLE = 0x45; //1.17 has 4 different packets for this.
    public static final int COMPRESSION = 0x46; //BROKEN! Set compression on login
    public static final int PLAYER_LIST_HEADER_AND_FOOTER = 0x47;
    public static final int RESOURCE_PACK_SEND = 0x48;
    public static final int UPDATE_ENTITY_NBT = 0x49; //does not exist in 1.17
