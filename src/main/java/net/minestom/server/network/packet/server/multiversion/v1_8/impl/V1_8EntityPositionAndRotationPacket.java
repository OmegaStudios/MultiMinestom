...
public class V1_8EntityPositionAndRotationPacket implements VersionedPacket {
    ...
    //https://wiki.vg/index.php?title=Protocol&oldid=7368#Entity_Look_And_Relative_Move
    @Override
    ...
    @Override
    public int getId() {
        return V1_8ServerPacketIdentifier.ENTITY_POSITION_AND_ROTATION;
    }
